...
def test_sianet_extractor_data_dna_km_rodado(mock_get, mock_auth_token):
    ...
    expected_url = f'http://siannet.gestaosian.com/api/BI_Extrator?nomeDNA=dna_fake&data={test_date}'
    ...
    sianet_extractor = SianetExtractor(base_url='http://siannet.gestaosian.com/api/WSLogin', nome_dna='dna_fake')
